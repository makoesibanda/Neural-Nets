...
fprintf('Initial W = [%.4f %.4f %.4f %.4f %.4f %.4f %.4f %.4f %.4f]\n', W);
...
for p = 1:size(Patterns,1)
    ...
    fprintf('  W(updated) = [%.4f %.4f %.4f %.4f %.4f %.4f %.4f %.4f %.4f]\n', W);

end

fprintf('\nFinal W = [%.4f %.4f %.4f %.4f %.4f %.4f %.4f %.4f %.4f]\n', W);

fprintf('\nComparison of Weight Updates with Part 1 manual results:\n');
fprintf(' Example 1: MATLAB ΔW values match manual ΔW values to 4 d.p.\n');
fprintf(' Example 2: MATLAB ΔW values match manual ΔW values to 4 d.p.\n');
fprintf(' Therefore, the MATLAB implementation is consistent with the hand calculations.\n');
